#! /usr/bin/env tclsh
puts "\n\n=============================================================="
puts "                    WELCOME TO BoltSynth"
puts "--------------------------------------------------------------"
puts "  An Open-Source Synthesis & STA Automation Tool"
puts "  Developed by Harshitha Kalur "
puts "  VLSI Design Corporation Pvt. Ltd. "
puts "==============================================================\n"

#----- Checks whether BoltSynth usage is correct or not -----#
set enable_prelayout_timing 1
set working_dir [exec pwd]
set boltsynth_array_length [llength [split [lindex $argv 0] .]]
set input [lindex [split [lindex $argv 0] .] $boltsynth_array_length-1]

if {![regexp {^csv} $input] || $argc!=1 } {
	puts "BoltSynth Error: Incorrect usage."
	puts "Usage: ./boltsynth <.csv>"
	puts "Where <.csv> contains required design configuration."
	exit
} else {

#------ Convert .csv to matrix and create initial variables ----------#
...
#	m add columns $columns
	...
	while {$i < $num_of_rows} {
		 puts "\nBoltSynth Info: Setting $my_arr(0,$i) as '$my_arr(1,$i)'"
		 if {$i == 0} {
...
puts "\nBoltSynth Info: Listing key variables for debug:"
...
if {! [file exists $EarlyLibraryPath]} {
	puts "\nBoltSynth Error: Early library not found at $EarlyLibraryPath. Exiting..."
	exit
} else {
	puts "\nBoltSynth Info: Early cell library found at $EarlyLibraryPath"
}

if {! [file exists $LateLibraryPath]} {
	puts "\nBoltSynth Error: Late library not found at $LateLibraryPath. Exiting..."
	exit
} else {
	puts "\nBoltSynth Info: Late cell library found at $LateLibraryPath"
}

if {! [file isdirectory $OutputDirectory]} {
	puts "\nBoltSynth Info: Creating output directory $OutputDirectory"
	file mkdir $OutputDirectory
} else {
	puts "\nBoltSynth Info: Output directory found at $OutputDirectory"
}

if {! [file isdirectory $NetlistDirectory]} {
	puts "\nBoltSynth Error: RTL netlist directory not found at $NetlistDirectory. Exiting..."
	exit	
} else {
	puts "\nBoltSynth Info: RTL netlist directory found at $NetlistDirectory"
}

if {! [file exists $ConstraintsFile]} {
	puts "\nBoltSynth Error: Constraints file not found at $ConstraintsFile. Exiting..."
	exit
} else {
	puts "\nBoltSynth Info: Constraints file found at $ConstraintsFile"
}
...
puts "\nBoltSynth Info: Dumping SDC constraints for $DesignName"
...
#---------------------------------optional script-------differentiating input ports as bused and bits----#
...
puts "splitting content of tmp_2 using spaces and counting number of elements as $count"
if {$count > 2} {
...
source /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/procs/reopenStdout.proc
source /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/procs/set_num_threads.proc
reopenStdout $OutputDirectory/$DesignName.conf
set_multi_cpu_usage -localCpu 4


source /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/procs/read_lib.proc
read_lib -early /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/osu018_stdcells.lib 

read_lib -late /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/osu018_stdcells.lib

source /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/procs/read_verilog.proc
read_verilog $OutputDirectory/$DesignName.final.synth.v


source /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/procs/read_sdc.proc
...
set tcl_precision 3
set time_elapsed_in_us [time {exec /home/vsduser/Downloads/VSD_TCL_PROGRAMMING_WORKSHOP-main/opentimer/OpenTimer-1.0.5/bin/OpenTimer < $OutputDirectory/$DesignName.conf >& $OutputDirectory/$DesignName.results}]
